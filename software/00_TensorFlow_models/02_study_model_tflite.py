...
print(" \n ");
print("************************************** ");
print(" Evaluate the performance of the CNN model  ");
...
#----------------------------------
# model of the CNN network with 1 filter and Mnist
#inter = tf.lite.Interpreter( model_path="models/quantized_tflite_model_test.tflite" );
# model of the CNN network with 12 filters and Mnist
...
# Define the input image (28,28,1)
img_test = \
...
# Pre-process input image: add dimension and convert to floating point
...
print(" \n ");
print("************************************** ");
print(" Layer inputs and outputs        ");
print("************************************** ");
